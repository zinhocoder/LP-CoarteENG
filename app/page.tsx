...
const WhatsAppFloatingButton = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-[#25D366] hover:bg-[#1DAE50] text-white p-3.5 rounded-full shadow-lg z-50 flex items-center justify-center transition-transform hover:scale-110"
...
export default function CoarteLandingPage() {
  const servicesSummary = [
    {
      icon: <Home className="h-10 w-10 text-amber-400" />,
    ...
    {
      icon: <ClipboardCheck className="h-10 w-10 text-amber-400" />,
    ...
    {
      icon: <Search className="h-10 w-10 text-amber-400" />,
  ...
  const detailedServices = [
    {
      id: "servico-avaliacao-detalhe",
      icon: <Home className="h-12 w-12 text-amber-400 mb-4" />,
      title: "Avaliação de Imóveis",
    ...
    {
      id: "servico-laudo-detalhe",
      icon: <Building className="h-12 w-12 text-amber-400 mb-4" />,
      title: "Laudo Estrutural",
    ...
    {
      id: "servico-vistoria-tecnica-detalhe",
      icon: <ClipboardCheck className="h-12 w-12 text-amber-400 mb-4" />,
      title: "Vistoria Técnica",
    ...
    {
      id: "servico-vistoria-apto-novo-detalhe",
      icon: <Search className="h-12 w-12 text-amber-400 mb-4" />,
      title: "Vistoria em Apartamento Novo",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-gray-200">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-20 md:py-32 bg-gradient-to-b from-black via-gray-900 to-black">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-black font-semibold px-8 py-3 text-lg"
              >
        ...
        <section id="storytelling" className="py-16 md:py-24 bg-gray-950">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-amber-400">A Fundação</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-amber-400">Nossa Missão e Valores</h3>
                    <p className="text-gray-300 mt-1">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-amber-400">Visão de Futuro</h3>
                    <p className="text-gray-300 mt-1">
              ...
              {servicesSummary.map((service) => (
                <a href={`#${service.id}`} key={service.title} className="block group">
                  <Card className="bg-gray-900 border-gray-800 text-gray-200 shadow-lg group-hover:shadow-amber-500/20 transition-all duration-300 group-hover:scale-105 h-full flex flex-col">
                    <CardHeader className="flex flex-col items-center text-center gap-3 pb-4 pt-6">
                      <div className="bg-gray-800 p-4 rounded-full">{service.icon}</div>
                      <CardTitle className="text-xl font-semibold text-amber-400">{service.title}</CardTitle>
                    </CardHeader>
        ...
        {detailedServices.map((service, index) => (
          <section
            id={service.id}
            key={service.id}
            className={`py-16 md:py-24 ${index % 2 === 0 ? "bg-gray-950" : "bg-black"}`}
          >
            <div className="container mx-auto px-4 md:px-6">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className={`flex justify-center ${service.layout === "imageLeft" ? "md:order-1" : "md:order-2"}`}>
                  <Image
                ...
                <div className={`${service.layout === "imageLeft" ? "md:order-2" : "md:order-1"}`}>
                  {service.icon}
                  <h3 className="text-3xl font-bold text-white sm:text-4xl mb-2">
                    {service.title} <span className="text-amber-400">{service.subtitle}</span>
                  </h3>
                  <p className="text-gray-300 text-lg mb-6 leading-relaxed">{service.fullDescription}</p>
        ...
        <section id="contact" className="py-16 md:py-24 bg-gradient-to-b from-black via-gray-900 to-black">
          <div className="container mx-auto px-4 md:px-6">
            <div className="bg-gray-900 p-8 md:p-12 rounded-xl shadow-2xl text-center border border-amber-500/50">
              ...
              <div className="mt-8">
                <Button
                  asChild
                  size="lg"
                  className="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-10 py-4 text-xl"
                >
                  <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-2xl mx-auto">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:contato@coarteengenharia.com.br" className="text-gray-300 hover:text-amber-400">
                    contato@coarteengenharia.com.br
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-6 w-6 text-amber-400" />
                  <span className="text-gray-300">(16) 99604-2857</span>
                </div>
              </div>
            </div>
          </div>
